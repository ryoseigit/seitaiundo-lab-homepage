...
export const researchTopics: ResearchTopic[] = [
  ...
  },
  {
    ...
    desc: "水晶振動子の共振周波数の変化を利用た、アクチンとミオシンの相互作用や粘弾性変化測定。Probing actin–myosin interactions through state-dependent frequency shifts by QCM.",
    image: "research-qcm.svg",
    overview: "QCMを用いて、アクチンとミオシンの相互作用や膜・フィラメント系の粘弾性変化を高感度に測定する方法を進めています。",
    details: [
      "水晶振動子の共振周波数変化を利用することで、分子間相互作用の質量・粘弾性変化をリアルタイムに評価できます。アクチンとミオシンの相互作用を定量的に捉えるための基盤として活用しています。",
      "この技術は、細胞骨格の力学応答や膜タンパク質の相互作用解析にも展開可能です。"
    ]
  }
];
